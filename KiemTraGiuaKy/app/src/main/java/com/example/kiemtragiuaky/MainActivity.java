...
import com.example.kiemtragiuaky.ArrayAdapterContactItem;
import com.example.kiemtragiuaky.ChiTietDonVi;
import com.example.kiemtragiuaky.ChiTietNhanVien;
import com.example.kiemtragiuaky.DonVi;
import com.example.kiemtragiuaky.NhanVien;
import com.example.kiemtragiuaky.SuaDonVi;
import com.example.kiemtragiuaky.SuaNhanVien;
import com.example.kiemtragiuaky.ThemDonVi;
import com.example.kiemtragiuaky.ThemNhanVien;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void addControl() {
        ...
        spec1.setIndicator("", getResources().getDrawable(R.drawable.school));
        tabHost.addTab(spec1);
        //Tab2
        spec2 = tabHost.newTabSpec("t2");
        spec2.setContent(R.id.tab_nhanvien);
        spec2.setIndicator("Nhân viên");
        spec2.setIndicator("", getResources().getDrawable(R.drawable.team));
